...
class Street(EdgePayload):
    ...
    @classmethod
    def setAlgorithms(cls, walk, walkback):
        ftpr = CFUNCTYPE(c_void_p, c_void_p, c_void_p)
        cls._algos = (ftpr(walk), ftpr(walkback))
        lgs.streetSetWalkAlgorithms(cls._algos[0], cls._algos[1])
