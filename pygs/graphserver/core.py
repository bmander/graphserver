...
class WalkOptions(CShadow):
    ...
    transfer_slack = cproperty(lgs.woGetTransferSlack, c_int, setter=lgs.woSetTransferSlack)
    max_transfers = cproperty(lgs.woGetMaxTransfers, c_int, setter=lgs.woSetMaxTransfers)
