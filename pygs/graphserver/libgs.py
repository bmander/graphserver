...
declarations = [\
    ...
    (libgs.gVertices, POINTER(LGSTypes.Vertex), [LGSTypes.Graph, POINTER(c_long)]),
    ...
    (libgs.sptVertices, POINTER(LGSTypes.SPTVertex), [LGSTypes.ShortestPathTree, POINTER(c_long)]),
    ...
    (libgs.sptvGetIncomingEdgeList, LGSTypes.ListNode, [LGSTypes.SPTVertex]),
    (libgs.sptvRemoveOutEdgeRef, None, [LGSTypes.SPTVertex, LGSTypes.Edge]),
    (libgs.sptvRemoveInEdgeRef, None, [LGSTypes.SPTVertex, LGSTypes.Edge]),
    (libgs.sptvGetLabel, c_char_p, [LGSTypes.SPTVertex]),
    (libgs.sptvDegreeOut, c_int, [LGSTypes.SPTVertex]),
    (libgs.sptvDegreeIn, c_int, [LGSTypes.SPTVertex]),
    ...
    (libgs.eGetFrom, LGSTypes.Vertex, [LGSTypes.Edge]),
    (libgs.eGetTo, LGSTypes.Vertex, [LGSTypes.Edge]),
    ...
    (libgs.pathNew, LGSTypes.Path, [LGSTypes.Vertex, c_int, c_int]),
    (libgs.pathDestroy, None, [LGSTypes.Path]),
    (libgs.pathGetVertex, LGSTypes.Vertex, [LGSTypes.Path, c_int]),
    (libgs.pathGetEdge, LGSTypes.Edge, [LGSTypes.Path, c_int]),
    (libgs.pathAddSegment, None, [LGSTypes.Path, LGSTypes.Vertex, LGSTypes.Edge]),
