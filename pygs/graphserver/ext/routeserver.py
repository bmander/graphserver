...
def main():
    ...
    def board_event(vertex1, edge, vertex2):
        ...
        route_desc = "-".join([str(x) for x in list( gtfsdb.execute( "SELECT routes.route_short_name, routes.route_long_name FROM routes, trips WHERE routes.route_id=trips.route_id AND trip_id=?", (trip_id,) ) )[0]])
