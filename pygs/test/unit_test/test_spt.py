...
class TestShortestPathTree(unittest.TestCase):
    ...
    def test_add_edge(self):
        ...
        assert (
            str(e)
            == "<Edge><Street name='helloworld' length='1.000000' rise='0.000000' fall='0.000000' way='0' reverse='False'/></Edge>"
        )
    ...
    def test_walk_longstreet(self):
        ...
        assert (
            str(sprime)
            == "<state time='3953' weight='5538153' dist_walked='24000.0' num_transfers='0' trip_id='None' stop_sequence='-1'></state>"
        )
