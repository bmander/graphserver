...
class TestStreet(unittest.TestCase):
    def test_street(self):
        ...
        assert (
            s.to_xml()
            == "<Street name='mystreet' length='1.100000' rise='0.000000' fall='0.000000' way='0' reverse='False'/>"
        )
    ...
    def test_street_elev(self):
        ...
        assert (
            s.to_xml()
            == "<Street name='mystreet' length='1.100000' rise='24.500000' fall='31.200001' way='0' reverse='False'/>"
        )
    ...
    def test_street_big_length(self):
        ...
        assert (
            s.to_xml()
            == "<Street name='longstreet' length='240000.000000' rise='0.000000' fall='0.000000' way='0' reverse='False'/>"
        )
